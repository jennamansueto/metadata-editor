	...
	function lock_post($sid=null)
	{
		try{
			...
			if (!isset($options['version_number']) || empty(trim($options['version_number']))){
				throw new Exception("VALIDATION_ERROR: Parameter `version_number` is required");
			}
